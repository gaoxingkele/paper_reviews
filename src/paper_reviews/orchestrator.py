...
def _spec_for(role: str, cfg: dict) -> AgentSpec:
    ...
    return AgentSpec(
        ...
        extra_providers=list(d.get("extra_providers", [])),
    )
...
class Orchestrator:
    ...
    # ---- stages ----
    def _run_dimension_reviews(self, paper: Paper) -> list[DimensionReview]:
        ...
        def _one(dim):
            ...
            return reviewer.review(paper, self.journal, dim)
